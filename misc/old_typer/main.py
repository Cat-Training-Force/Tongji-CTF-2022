...
# def substitution(text: str, k: int) -> str:
# pass


def morse_encode(text: str) -> str:
    return ' '.join([code[ch] for ch in text.upper()])
...
def tprint(text: str):
    ...
    for i, ch in enumerate(text):
        ...
        time.sleep(delay[ch])
        print(story[i % l], end='', flush=True)
...
def main():
    ...
    import sys
    print('Are you ready to read the book?')
    sys.stdout.flush()
    sys.stdin.readline().strip()
    tprint(morse_encode(args.input))


if __name__ == '__main__':
    main()

# ./main.py "tjctf(1170c2fc9099073edf99cde29a8b0162)"
